...
public class Keys {
    ...
    public static final ForeignKey<LinkChatRecord, ChatRecord> CONSTRAINT_47 = Internal.createForeignKey(LinkChat.LINK_CHAT, DSL.name("CONSTRAINT_47"), new TableField[] { LinkChat.LINK_CHAT.CHAT_ID }, Keys.CONSTRAINT_1, new TableField[] { Chat.CHAT.CHAT_ID }, true);
}
