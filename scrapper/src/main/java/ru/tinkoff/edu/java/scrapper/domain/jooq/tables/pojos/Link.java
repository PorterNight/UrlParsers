...
public class Link implements Serializable {
    ...
    public Link(Link value) {
        ...
        this.newEventCreatedAt = value.newEventCreatedAt;
    }
    ...
    public Link(
        ...
        @Nullable OffsetDateTime newEventCreatedAt
    ) {
        this.id = id;
        this.url = url;
    ...
    public OffsetDateTime getNewEventCreatedAt() {
        return this.newEventCreatedAt;
    }

    /**
     * Setter for <code>LINK.NEW_EVENT_CREATED_AT</code>.
     */
    public void setNewEventCreatedAt(@Nullable OffsetDateTime newEventCreatedAt) {
        this.newEventCreatedAt = newEventCreatedAt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.updatedAt == null) {
            ...
            return false;
        if (this.newEventCreatedAt == null) {
            if (other.newEventCreatedAt != null)
                return false;
        }
        else if (!this.newEventCreatedAt.equals(other.newEventCreatedAt))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.newEventCreatedAt == null) ? 0 : this.newEventCreatedAt.hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", ").append(newEventCreatedAt);
