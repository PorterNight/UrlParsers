...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>LINK.NEW_EVENT_CREATED_AT</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> NEW_EVENT_CREATED_AT = createField(DSL.name("NEW_EVENT_CREATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
